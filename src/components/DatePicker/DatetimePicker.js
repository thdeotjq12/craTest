...
class DatetimePicker extends Component {
  ...
  componentDidMount() {
    ...
    this.flatpickr = flatpickr(
      this.datetimeRef,
      { ...props, defaultDate: defaultDate || defaultValue },
      this.type,
  ...
  componentWillReceiveProps(nextProps) {
    if (
      ...
      !arrayEquals(this.props.defaultDate, nextProps.defaultDate)
    ) {
      this.setState({
        dateStr: formatDateString(
          nextProps.mode,
          nextProps.defaultDate,
          this.type.dateFormat
        )
      });
    }
  ...
  onChangeCallback(selectedDates, dateStr, instance) {
    if (
      ...
      (!selectedDates || (selectedDates && selectedDates.length < 2))
    )
      return;
    ...
    return this.props.children ? (
      ...
      >
        <input
          ...
          onChange={
            this.props.allowInput || !this.props.readOnly ? this.onChange : null
          }
          onKeyPress={this.onKeyPress}
          onBlur={this.onBlur}
          onClick={
            this.props.clickOpens && !this.props.allowInput ? this.onOpen : null
          }
        />
